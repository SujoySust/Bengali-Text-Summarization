...
<div class="container">
    <div class="panel panel-success">
        ...
        <div class="panel-heading text-center">Extractive English Summarization</div>
        <div class="panel-body">
            <h1 class="card-title text-center"></h1>
            <div class="row">
                <div class="col-md-12">
                    <form id="task-form" method="post" action="{{url('summary/extractive/english')}}">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <lable class="form-control">Input English  Text Here For Extractive Summary</lable>
                        </div>
